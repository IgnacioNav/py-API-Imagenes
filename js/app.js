...
function buscarImagenes() {
    ...
    const key = '29441181-8e1b300d5b66cca6b4047c270';
...
// Generador que registra la cantidad de elementos por páginas
...
function imprimirPaginador() {
    ...
    while(true) {
        ...
        // Al llegar al final de la pág, no retorna nada mas.
        if(done) return;  
        ...
        boton.onclick = () => {
            ...
            // Buscar imagenes con el valor actual
            buscarImagenes();
        }
...
function mostrarAlerta(mensaje) {
    ...
    if(!existeAlerta){
        ...
        alerta.innerHTML = `
            <strong classs="font-bold">Error!</strong>
